...
(
   ...
   CONSTRAINT [FK_Facturacion_ToTable] FOREIGN KEY (cc_cliente) REFERENCES [Cliente] ([id_cliente]),
   CONSTRAINT [FK_Facturacion_ToTable_1] FOREIGN KEY ([cc_personal]) REFERENCES [Personal] ([cc_personal]),
   CONSTRAINT [FK_Facturacion_ToTable_2] FOREIGN KEY ([id_venta]) REFERENCES [Venta] ([cc_venta])
)
